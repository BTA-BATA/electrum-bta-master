...
try:
    from ,tc_scrypt import getPoWHash
except ImportError:
...
class Blockchain():
    ...
    def __init__(self, config, network):
        ...
        self.headers_url = 'http://104.236.239.154/blockchain_headers'
        self.local_height = 0
    ...
    def get_target(self, index, chain=None):
        ...
        # BataCoin: go back the full period unless it's the first retarget
        if index == 1:
