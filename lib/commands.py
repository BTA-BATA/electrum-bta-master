...
class Commands:
    ...
    def createrawtx(self, inputs, outputs, unsigned=False):
        """Create a transaction from json inputs. The syntax is similar to batacoind."""
    ...
    def version(self):
        ...
        import electrum_BTA as electrum  # Needs to stay here to prevent ciruclar imports
    ...
    def setlabel(self, key, label):
        """Assign a label to an item. Item may be a BataCoin address or a
        transaction ID"""
    ...
    def _format_request(self, out):
        ...
        out['amount'] = format_satoshis(out.get('amount')) + ' BTA'
...
param_descriptions = {
    ...
    'destination': 'BataCoin address, contact or alias',
    'address': 'BataCoin address',
    'seed': 'Seed phrase',
    'txid': 'Transaction ID',
    'pos': 'Position',
    'height': 'Block height',
    ...
    'amount': 'Amount to be sent (in BTA). Type \'!\' to send the maximum available.',
    'requested_amount': 'Requested amount (in BTA).',
    'csv_file': 'CSV file of recipient, amount',
}

command_options = {
    'broadcast':   (None, "--broadcast",   "Broadcast the transaction to the BataCoin network"),
    ...
    'tx_fee':      ("-f", "--fee",         "Transaction fee (in BTA)"),
...
config_variables = {
    ...
    'addrequest': {
        ...
        'url_rewrite': 'Parameters passed to str.replace(), in order to create the r= part of batacoin: URIs. Example: \"(\'file:///var/www/\',\'https://electrum-BTA.org/\')\"',
    },
    'listrequests':{
        'url_rewrite': 'Parameters passed to str.replace(), in order to create the r= part of batacoin: URIs. Example: \"(\'file:///var/www/\',\'https://electrum-BTA.org/\')\"',
    }
...
def get_parser(run_gui, run_daemon, run_cmdline):
    ...
    group.add_argument("-P", "--portable", action="store_true", dest="portable", default=False, help="Use local 'electrum-BTA_data' directory")
    group.add_argument("-w", "--wallet", dest="wallet_path", help="wallet path")
    group.add_argument("-o", "--offline", action="store_true", dest="offline", default=False, help="Run offline")
    # create main parser
    parser = argparse.ArgumentParser(
        parents=[parent_parser],
        epilog="Run 'electrum-BTA help <command>' to see the help for a command")
    ...
    parser_gui.add_argument("url", nargs='?', default=None, help="batacoin URI (or bip70 file)")
