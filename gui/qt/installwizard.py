...
from electrum_bta import Wallet
...
from electrum_bta.plugins import always_hook, run_hook
from electrum_bta.mnemonic import prepare_seed

MSG_ENTER_ANYTHING    = _("Please enter a seed phrase, a master key, a list of BataCoin addresses, or a list of private keys")
