...
from electrum_bta.bitcoin import is_valid
...
import re
import time
from electrum_bta.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_bta import util
import datetime

from electrum_bta.version import ELECTRUM_VERSION as electrum_version
from electrum_bta.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a BataCoin address or contact"))
        ...
        self.setWindowTitle("Electrum-BTA")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your BataCoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive BataCoin payment"))
