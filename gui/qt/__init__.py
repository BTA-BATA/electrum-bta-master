...
from electrum_bta.i18n import _, set_language
from electrum_bta.util import print_error, print_msg
from electrum_bta.plugins import run_hook, always_hook
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-BTA"), self.close)
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-BTA')
