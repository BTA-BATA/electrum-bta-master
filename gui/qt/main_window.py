...
from electrum_bta.bitcoin import MIN_RELAY_TX_FEE, COIN, is_valid
from electrum_bta.plugins import run_hook
from electrum_bta.i18n import _
from electrum_bta.util import block_explorer, block_explorer_info, block_explorer_URL
from electrum_bta.util import print_error, print_msg
from electrum_bta.util import format_satoshis, format_satoshis_plain, format_time, NotEnoughFunds, StoreDict
from electrum_bta import Transaction
from electrum_bta import mnemonic
from electrum_bta import util, bitcoin, commands, Wallet
from electrum_bta import SimpleConfig, Wallet, WalletStorage
from electrum_bta import Imported_Wallet
from electrum_bta import paymentrequest
from electrum_bta.contacts import Contacts
...
from electrum_bta import ELECTRUM_VERSION
import re
...
from electrum_bta.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_bta.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request, make_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-bta.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-BTA %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://electrum-bta.org"))
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-BTA",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum's focus is speed, with low resource usage and simplifying BataCoin. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the BataCoin system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-BTA - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/pooler/electrum-bta/issues\">https://github.com/pooler/electrum-bta/issues</a>")
    ...
    def notify(self, message):
        if self.tray:
            self.tray.showMessage("Electrum-BTA", message, QSystemTrayIcon.Information, 20000)
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter a BataCoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a BataCoin address)')
        ...
        msg = _('BataCoin transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('BataCoin Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid BataCoin Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_from_URI(self,URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid batacoin URI:') + '\n' + str(e), _('OK'))
            return
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive batacoins.") + " " \
    ...
    def read_tx_from_qrcode(self):
        from electrum_bta import qrscanner
        try:
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-bta-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-bta_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        vbox = QVBoxLayout(d)
        defaultname = os.path.expanduser('~/electrum-bta-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_bta.i18n import languages
    ...
    def plugins_dialog(self):
        from electrum_bta.plugins import plugins, descriptions, is_available, loader
