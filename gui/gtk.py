...
from electrum_bta.util import print_error, InvalidPassword
from electrum_bta.bitcoin import is_valid, COIN
from electrum_bta.wallet import NotEnoughFunds
from electrum_bta import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-BTA"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_bta.util import format_satoshis, parse_URI
from electrum_bta.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-BTA ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_bta.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid batacoin address:\n"+to_address)
            return
