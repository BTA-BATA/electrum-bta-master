...
imp.load_module('electrum_bta', *imp.find_module('lib'))

from electrum_bta import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_bta import util
from electrum_bta.transaction import Transaction
from electrum_bta.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-BTA Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-bta/authenticator')
