import time, electrum_bta as electrum, Queue
from electrum_bta import Interface, SimpleConfig
from electrum_bta.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    q = Queue.Queue()
    interface = electrum.Interface('electrum-bta.bysh.me:50002:s', q)
    interface.start()
    i, r = q.get()
