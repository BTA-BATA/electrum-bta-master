...
from electrum_bta import bitcoin

from electrum_bta.account import BIP32_Account
from electrum_bta.bitcoin import EncodeBase58Check, public_key_to_bc_address, bc_address_to_hash_160, xpub_from_pubkey
from electrum_bta.i18n import _
from electrum_bta.plugins import BasePlugin, hook, always_hook, run_hook
from electrum_bta.transaction import Transaction, deserialize, is_extended_pubkey, x_to_xpub
from electrum_bta.wallet import BIP32_HD_Wallet
from electrum_bta.util import print_error, print_msg
from electrum_bta.wallet import pw_decode, bip32_private_derivation, bip32_root
...
class Plugin(BasePlugin):
    ...
    def show_address(self, address):
        ...
        try:
            ...
            give_error(e)
        try:
            self.get_client().get_address('BataCoin', address_n, True)
        except Exception, e:
            give_error(e)
        finally:
            self.handler.stop()
    ...
    def sign_transaction(self, tx, prev_tx, xpub_path):
        ...
        #try:
        signed_tx = client.sign_tx('BataCoin', inputs, outputs)[1]
        #except Exception, e:
        #    give_error(e)
        #finally:
        self.handler.stop()
...
class TrezorWallet(BIP32_HD_Wallet):
    ...
    def sign_message(self, address, message, password):
        ...
        try:
            ...
            give_error(e)
        try:
            msg_sig = self.plugin.get_client().sign_message('BataCoin', address_n, message)
        except Exception, e:
            give_error(e)
        finally:
    ...
    def check_proper_device(self):
        ...
        if not self.device_checked:
            ...
            device_address = self.get_client().get_address('BataCoin', n)
